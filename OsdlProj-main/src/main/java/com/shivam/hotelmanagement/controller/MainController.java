package com.shivam.hotelmanagement.controller;

import java.io.IOException;

import com.shivam.hotelmanagement.service.HotelService;
...
public class MainController {
    private static final String LIGHT_THEME = "/com/shivam/hotelmanagement/styles/app.css";
    private static final String DARK_THEME = "/com/shivam/hotelmanagement/styles/dark.css";
    ...
    private void showRooms() {
        currentViewPath = "/com/shivam/hotelmanagement/view/rooms-view.fxml";
        loadView(currentViewPath);
    }

    @FXML
    private void showCustomers() {
        currentViewPath = "/com/shivam/hotelmanagement/view/customers-view.fxml";
        loadView(currentViewPath);
    }

    @FXML
    private void showBilling() {
        currentViewPath = "/com/shivam/hotelmanagement/view/billing-view.fxml";
        loadView(currentViewPath);
    }
