package com.shivam.hotelmanagement.service;
...
import com.shivam.hotelmanagement.model.Bill;
import com.shivam.hotelmanagement.model.Customer;
import com.shivam.hotelmanagement.model.Room;
import com.shivam.hotelmanagement.repository.BillRepository;
import com.shivam.hotelmanagement.repository.CustomerRepository;
import com.shivam.hotelmanagement.repository.RoomRepository;
...
public class HotelService {
    ...
    private <T> T runInTransaction(SqlFunction<Connection, T> action) {
        try (Connection connection = com.shivam.hotelmanagement.db.Database.getConnection()) {
